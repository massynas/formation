<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Requêtes HTTP</v-card-title>
        <v-card-text>
          <h2 class="subheading primary--text pa-2">Architecture</h2>
          ...
          <p>La méthode <code>fetch</code> permet de lancer une requête HTTP en JavaScript et retourne une <code>Promise</code>. Elle n'est pas supportée sur Internet Explorer mais il existe des <i>polyfills</i> pour compléter le support. Comme alternative, vous pouvez passer par d'autres bibliothèques spécialisées telles que
          <a href="https://github.com/axios/axios" target="_blank">Axios</a>, qui est recommandée par l'équipe de Vue.</p>
          ...
          <h2 class="subheading primary--text pa-2">Création de services</h2>
          <p>- Créer un service générique permettant d'appeler le backend, pour cela, créer un fichier <code>services/api.js</code> :</p>
          <code-copy :code="service_api" :copyable="true" language="javascript" />
          ...
          <code-copy :code="service_user" :copyable="true" language="javascript"/>

          <h2 class="subheading primary--text pa-2">Utilisation des services</h2>
          ...
          <code-copy :code="service_call" language="javascript" />
          ...
          <code-copy :copyable="true" :code="store_user" language="javascript"></code-copy>
          ...
          <v-alert :value="true" color="info" icon="info" outline>
            ...
            <p>La partie "backend" de ce TP a été déployée sur Heroku ; le contrat d'interface du service est disponible sur : <a href="https://vue-js-backend.herokuapp.com/api-docs" target="_blank">api-docs</a></p>
          </v-alert>
          <ol class="pt-4">

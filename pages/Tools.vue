<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Outillage</v-card-title>
        <v-card-text>
          ...
          <h2 class="subheading primary--text pa-2">Node.js</h2>
          <p>
            Installez
            <a href="https://nodejs.org/" target="_blank">Node.js</a> (version 8.x minimum). Vous pouvez utilisez
            <a
              target="_blank"
          ...
          <h2 class="subheading primary--text pa-2">Visual Studio Code et Vetur</h2>
          ...
          <h2 class="subheading primary--text pa-2">Vue Devtools</h2>
          <p>Téléchargez l'extension <a href="https://github.com/vuejs/vue-devtools" target="_blank">vue-devtools</a> disponible sur Chrome, Firefox ou en application standalone. Cela vous aidera pour le débogage lors des TP.</p>

          <h2 class="subheading primary--text pa-2">Vue CLI</h2>
          ...
          <code-copy language="console">npm install -g @vue/cli</code-copy>
          <p>Vous avez désormais accès à la commande <code>vue</code> depuis un terminal. Essayez-la pour vérifier la bonne installation et pour avoir plus d'informations sur les commandes disponibles:</p>
          <pre><code>$ vue
...
Commands:
  ...
  Run vue &lt;command> --help for detailed usage of given command.
          ...
          <p class="mt-3">La commande <code>vue ui</code> est très utile pour les débutants: elle fournit une interface graphique sur navigateur dédiée à la gestion des projets Vue et aux tâches courantes d'un projet Vue. L'UI peut remplacer la ligne de commande pour de nombreuses tâches, comme par exemple:</p>
          <ul>
          ...
          <div class="text-xs-center">
            <img src="~/assets/img/vue-cli-3-serve.gif" height="400">
...
&lt;/html&gt;
      ...
      <v-card>
        <v-card-title class="headline primary--text">Création de votre premier projet</v-card-title>
        <v-card-text>
          <p>
            Placez-vous dans votre répertoire de travail et créez un projet appelé
            <code>search-films</code> en lançant la commande :
          </p>
          <code-copy code="vue create search-films" language="console"></code-copy>
          <p>
          ...
          <code-copy code="cd search-films"></code-copy>

          <v-card-title class="subheading primary--text">Travailler en mode développeur</v-card-title>
          <p>Pour travailler sur l'application et la tester en direct, lancez la commande suivante:</p>
          <code-copy code="npm run serve"></code-copy>
          <p>
          ...
          <v-card-title class="subheading primary--text">Build pour la production</v-card-title>
          <p>Vous pouvez à tout moment packager votre projet pour la production avec la commande :</p>
          <code-copy code="npm run build"></code-copy>
          <p>
          ...
          <v-alert
            ...
            icon="info"
            outline
          >Les commandes de base de Vue CLI sont listées dans le README.md à la racine du projet</v-alert>

          <v-card-title class="subheading primary--text">Configuration du projet</v-card-title>
          <p>
...
module.exports = {
  devServer: {
    port: 3000
        ...
        <v-card-actions>
          <v-btn color="primary" flat nuxt to="/presentation">
            <v-icon left>navigate_before</v-icon>Présentation
          </v-btn>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/vues">Vues

<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Réactivité</v-card-title>
        <v-card-text>
          ...
          <h2 class="subheading primary--text pa-2">Getters / setters (ECMAScript 5)</h2>
          <code-copy :code="example_getters_setters" language="javascript" />
          ...
          <div class="text-xs-center">
            <img src="~/assets/img/getters-setters.jpg" height="300">
            <p>Principe de réactivité basé sur les getters/setters</p>
          </div>

          <h2 class="subheading primary--text pa-2">Proxies (ECMAScript 6)</h2>
          <code-copy :code="example_proxy" language="javascript" />
          ...
          <h2 class="subheading primary--text pa-2">Détail du système de réactivité de Vue</h2>
          <div class="text-xs-center">
            <img src="~/assets/img/vue-reactivity.jpg" height="500">
          </div>

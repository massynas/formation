<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline">Directives</v-card-title>
        <v-card-text>
          <p>Les directives sont les éléments de syntaxe propres à Vue utilisables dans les templates des composants Vue.</p>
          <v-card-title class="subheading primary--text">v-bind (:)</v-card-title>
          <p>Permet de lier (<em>bind</em>) la valeur d'un attribut d'un élément HTML à une variable du composant.</p>
          <code-copy :code="example_vbind" language="html"></code-copy>

          <p><a href="https://codepen.io/sylvainpv/pen/LBgqbq?editors=1010" target="_blank">
          Exercice: essayez de lier les attributs <code>src</code> et <code>width</code> de l'image
          </a></p>

          <v-card-title class="subheading primary--text">Lier des classes et des styles</v-card-title>
          <p>Plusieurs syntaxes sont proposées pour assigner des classes ou des styles CSS</p>
          <code-copy :code="example_bind_css" language="html"></code-copy>
          <p><a href="https://codepen.io/sylvainpv/pen/qyJgLe?editors=1010" target="_blank">
          Exercice: assignez une classe et une couleur à chaque fantôme
          </a></p>

          <v-card-title class="subheading primary--text">v-model: Formulaires et inputs</v-card-title>
          ...
          <code-copy :code="example_vmodel" language="html"></code-copy>
          <p><a href="https://codepen.io/sylvainpv/pen/rrqEMg?editors=1010" target="_blank">
          Exercice: utilisez v-model sur les input, select, radio et checkbox
          </a></p>

          <v-card-title class="subheading primary--text">v-if: Conditions</v-card-title>
          ...
          <code-copy :code="example_vif" language="html"></code-copy>
          <p><a href="https://codepen.io/sylvainpv/pen/bjmXXV?editors=1010" target="_blank">
          Exercice: utilisez v-if et v-else pour alterner les visages selon la condition
          </a></p>

          <v-card-title class="subheading primary--text">v-for: Boucles</v-card-title>
          ...
          <code-copy :code="example_vfor" language="html"></code-copy>
          <p><a href="https://codepen.io/sylvainpv/pen/RBqbBW?editors=1010" target="_blank">
          Exercice: utilisez deux boucles v-for pour afficher tout le contenu du panier
          </a></p>

          <v-card-title class="subheading primary--text">v-on (@)</v-card-title>
          ...
          <code-copy :code="example_von" language="html"></code-copy>
          <p><a href="https://codepen.io/sylvainpv/pen/NBEKQw?editors=1010" target="_blank">
          ...
          <v-card-title class="subheading primary--text">Modificateurs</v-card-title>
          <p>Les modificateurs sont des suffixes permettant de modifier légèrement le comportement de certaines directives ; par exemple, stopper la propagation d'un événement capturé avec <code>v-on</code>. Pour en savoir plus, se référer à la <a href="https://fr.vuejs.org/v2/guide/events.html#Event-Modifiers" target="_blank">documentation officielle</a>.</p>
          <code-copy :code="example_modifiers" language="html"></code-copy>

          <v-card-title class="headline primary--text">TP</v-card-title>
          <ol>
            ...
            <li>Sous le formulaire d'authentification, ajoutez le HTML suivant
              <code-copy copyable="true" language="html" :code="tp_film_card"></code-copy>
            </li>
            ...
            <li>Ajoutez la variable suivante dans l'option <code>data</code> du composant:
            <code-copy copyable="true" language="javascript" :code="tp_films_data"></code-copy>
            </li>
        ...
        <v-card-actions>
          <v-btn color="primary" flat nuxt to="/vues">
            <v-icon left>navigate_before</v-icon>
            Vues
          </v-btn>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/components">
            Composants

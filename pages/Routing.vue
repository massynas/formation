<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Routage</v-card-title>
        <v-card-text>
          ...
          <h2 class="subheading primary--text pa-2">Installation</h2>
          ...
          <h2 class="subheading primary--text pa-2">Exemple de configuration</h2>
          <code-copy :code="example_router_config"></code-copy>

          <p>Notez que le fichier <code>main.js</code> a été modifié pour déclarer ce nouveau routeur</p>
          <code-copy code="import router from './router'
...
new Vue({
  ...
  router
          ...
          <h2 class="subheading primary--text pa-2">Fonctionnement</h2>
          ...
          <code-copy code='<template>
  <div class="app">
    <router-view></router-view>
    <footer>Made with Vue</footer>
  </div>
</template>' language="html"></code-copy>

          <h2 class="subheading primary--text pa-2">Navigation et router-link</h2>
          ...
          <code-copy :code="example_router_link" language="html"></code-copy>
          <p>Il fournit également des méthodes à tous les composants pour naviguer programmatiquement entre les pages</p>
          <code-copy language="javascript" :code="example_router_api" />

          <h1 class="headline primary--text pa-4">TP</h1>
          <ol>
            <li>Installez vue-router sur votre projet. Attention, le contenu de <code>App.vue</code> sera écrasé !</li>
            <li>Créer une route <code>/login</code> qui affiche le composant de connexion, et <code>/search</code> pour le formulaire de recherche et les résultats. Ces deux routes remplaceront</li>
            <li>A l'aide de la documentation de <a href="https://router.vuejs.org/api/" target="_blank">vue-router</a>, remplacez la bascule entre LoginForm et SearchFilm à base de <code>v-if</code> en naviguant d'une route à une autre à la place.</li>
            <li><i>Bonus</i>: en utilisant les <a href="https://router.vuejs.org/guide/advanced/navigation-guards.html" target="_blank">Navigation Guards</a> de vue-router, redirigez l'utilisateur voulant accéder à la page de recherche de films vers la page d'authentification si l'utilisateur n'est pas loggé.</li>
          </ol>
        </v-card-text>
        <v-card-actions>
          <v-btn color="primary" flat nuxt to="/state">

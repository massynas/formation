<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Gestion d'état</v-card-title>
        ...
        <v-card-text>
          ...
          <h2 class="subheading primary--text pa-2">Pourquoi une solution de gestion d'état ?</h2>
          <img src="https://i.imgur.com/PSYBCRG.png" alt="Problème multiple vues avec props partagés">
          <ul>
          ...
          <h2 class="subheading primary--text pa-2">Données partagées par référence</h2>
          ...
          <code-copy language="javascript" :code="example_shared_state" />
          ...
          <h2 class="subheading primary--text pa-2">Store et mutations contrôlées</h2>
          ...
          <code-copy language="javascript" :code="example_store" />
          <code-copy language="html" :code="example_store_template" />

          <h2 class="subheading primary--text pa-2">Vuex</h2>
          ...
          <p><a href="https://vuex.vuejs.org/" target="_blank">Vuex</a> est l'aboutissement de ce pattern de store. Il est fourni par l'équipe de Vue comme solution "officielle" de gestion d'état, et sert de store centralisé pour tous les composants d'une application. Il fonctionne selon les principes suivants:</p>
          ...
          <img src="https://vuex.vuejs.org/vuex.png" alt="Vuex et les composants">
          <h2 class="subheading primary--text pa-2">Installation de vuex</h2>
          <p>Installer la dépendance Vuex, ainsi que Vuex-PersistedState pour persister les stores dans le localStorage</p>
          <code-copy code="npm install vuex vuex-persistedstate" language="shell"></code-copy>
          <h2 class="subheading primary--text pa-2">Création d'un Store vuex</h2>
          <p>- Créer un fichier <code>src/store.js</code>, et y placer le contenu suivant</p>
          <code-copy :copyable="true" :code="vuex_store"></code-copy>
            ...
            <code-copy code="import store from '@/store'
...
"></code-copy>
          ...
          <code-copy code="this.$store.dispatch('setLoggedIn', true)"></code-copy>
          <p>- Pour déclarer une variable du Store comme propriété</p>
          <code-copy code="import {mapState} from 'vuex'
computed: {
    ...mapState([
      'loggedIn'
    ])
        ...
        <v-card-actions>
          ...
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/routing">
            Routage

<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline primary--text">Vues</v-card-title>
        <v-card-text>
          <v-card-title class="subheading primary--text">Aperçu d'un projet Vue</v-card-title>
          ...
          <v-card-title class="subheading primary--text">Fichiers .vue</v-card-title>
          <ul>
            ...
            <li> Un fichier <code>.vue</code> se compose de trois éléments éléments optionnels :
              <ul>
          ...
          <code-copy :code="snippets.helloWorldTemplate" language="html"></code-copy>
        ...
        <v-card-title class="subheading primary--text">Travailler en composants</v-card-title>
          ...
          <div class="text-xs-center">
            <img src="~/assets/img/component-tree.png" alt="Component tree" class="mb-5" height="200">
          </div>
          ...
          <code-copy language="html" :code="snippets.childComponent"></code-copy>
          ...
          <v-card-title class="subheading primary--text">Interpolation de texte dans les templates</v-card-title>
          <p>Le moyen le plus simple d'insérer des données dynamiquement dans vos composants est par interpolation de texte, au moyen de la syntaxe <code v-pre>{{maVariable}}</code>. A l'intérieur des doubles accolades, vous pouvez indiquer n'importe quelle expression JavaScript valide:
          <code-copy class="mt-2" language="html" :code="snippets.interpolationExample"></code-copy>
          <p>L'interpolation ne fonctionne que sur le contenu textuel des éléments. Vous ne pouvez pas l'utiliser pour changer la valeur d'attributs HTML ou pour insérer du code HTML par exemple. Pour cela, vous devrez recourir aux directives, que l'on verra dans la section suivante.</p>

          <v-card-title class="headline primary--text">TP</v-card-title>
          <ol>
            <li>Ajouter la feuille de style CSS qui servira de base pour tout le TP. Vous pouvez la télécharger ici: <a href="./stylesheet.css" download>stylesheet.css</a> ; la placer dans le dossier <code>src</code> et l'inclure dans le projet avec <code>import "./stylesheet.css"</code> dans la partie script de <code>App.vue</code></li>
            <li>Créer un nouveau composant <code>LoginForm.vue</code> contenant un formulaire d'authentification</li>
            <code-copy language="html" :code='snippets.loginFormExercise'></code-copy>
        ...
        <v-card-actions>
          <v-btn color="primary" flat nuxt to="/tools">
            <v-icon left>navigate_before</v-icon>
            Outillage
          </v-btn>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/directives">
            Directives

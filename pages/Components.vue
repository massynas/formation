<template>
    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        <v-card-title class="headline">Composants</v-card-title>
        <v-card-text>
          ...
          <h2 class="subheading primary--text pa-2">Méthodes</h2>
          ...
          <code-copy language="html" :code="exampleMethods" />

          <h2 class="subheading primary--text pa-2">Computed et watchers</h2>
          ...
          <code-copy language="javascript" :code="exampleComputedWatchers" />
          ...
          <h2 class="subheading primary--text pa-2">Cycle de vie d'un composant</h2>
          ...
          <img src="https://fr.vuejs.org/images/lifecycle.png" height="1519" width="600" alt="Vue Lifecycle">
          ...
          <code-copy language="javascript" :code="example_lifecycle"></code-copy>
          ...
          <code-copy language="html" code="<ma-popin title='Confirmation' :actions='confirmActions'></ma-popin>" />
          ...
          <code-copy language="javascript" :code="example_events"></code-copy>

          <h2 class="subheading primary--text pa-2">Distribution de contenu avec les <strong>slots</strong></h2>
          ...
          <code-copy language="html">&lt;navigation-link url="/profile"&gt;Mon profil&lt;navigation-link&gt;</code-copy>
          ...
          <code-copy language="html" :code="example_slots"></code-copy>
          ...
          <h2 class="subheading primary--text pa-2">Référencer un élément dans un template</h2>
          ...
          <code-copy language="html" :code="example_refs"></code-copy>
          <code-copy language="javascript" :code="example_refs_js"></code-copy>

          <h2 class="subheading primary--text pa-2">API complète d'un composant Vue</h2>
          <code-copy language="javascript" :code="componentApi"></code-copy>

          <h2 class="subheading primary--text pa-2">Propriétés d'instance de vue</h2>
          <ul>
          ...
          <h2 class="subheading primary--text pa-2">Méthodes d'instance de vue</h2>
          <ul>
          ...
          <h1 class="headline primary--text pa-4">TP</h1>
          <ol>
        ...
        <v-card-actions>
          ...
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/reactivity">
            Réactivité
